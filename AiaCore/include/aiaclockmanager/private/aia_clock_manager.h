 ...
 * @brief Private functions of the @c AiaClockManager_t type.
 */

#ifndef PRIVATE_AIA_CLOCK_MANAGER_H_
#define PRIVATE_AIA_CLOCK_MANAGER_H_
...
/**
 * This function may be used to notify the @c clockManager of a new sequenced
 * @c SetClock directive.
 *
 * @param clockManager The @c AiaClockManager_t to act on.
...
void AiaClockManager_OnSetClockDirectiveReceived(
    void* clockManager, const void* payload, size_t size,
    AiaSequenceNumber_t sequenceNumber, size_t index );

#endif /* ifndef PRIVATE_AIA_CLOCK_MANAGER_H_ */
